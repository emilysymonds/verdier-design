...
$arrayTeam=cargarOurWork();

?> 
<p>&nbsp;</p>
<form action="processTrabajo.php?action=add" method="post"  name="frmListTeam" id="frmListTeam">
...
if (sizeof($arrayTeam) > 0) {
	...
	foreach($arrayTeam as $x) {
		...
		if ($x['imagen']) {
			$x['imagen'] = WEB_ROOT . 'images/Fotos/' . $x['imagen'];
		} else {
...
?>
  <tr class="<?php echo $class; ?>"> 
   ...
   <td width="70" align="center"><a href="javascript:deleteTrabajo(<?php echo $x['id']; ?>);">Delete</a></td>
  </tr>
  <?php
	} // end foreach
